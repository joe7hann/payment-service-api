...
SECRET_KEY = 'django-insecure-5lwlo38z)r8oul!&hlbtf6_e2posu89ozfzwmy9_g1w+z)r(4w'
...
INSTALLED_APPS = [
    ...
    'payment_user.apps.PaymentUserConfig',
    'expired_payment.apps.ExpiredPaymentConfig'
]
